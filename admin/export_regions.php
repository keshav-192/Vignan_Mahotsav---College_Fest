...
$sql .= " GROUP BY u.state, u.district ORDER BY participants DESC";

$res = $conn->query($sql);

header('Content-Type: text/csv; charset=utf-8');
header('Content-Disposition: attachment; filename="region_stats.csv"');

$out = fopen('php://output', 'w');
fputcsv($out, ['State', 'District', 'Participants']);
